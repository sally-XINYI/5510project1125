...
export const getRealEstateList = data => fetch('/v1/realEstate/list', data);

//获取deposit列表

export const getDepositList = data => fetch('/v1/deposit/list', data);

//获取receivables列表

export const getReceivablesList = data => fetch('/v1/receivable/list',data);
...
export const getRepayment = repayment_id => fetch('v1/repayment/' + repayment_id)
